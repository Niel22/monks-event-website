...
const Header = () => {
  return (
    <div className='overflow-hidden bg-[#0a0301]'>   
        <Navbar />
        <div className='relative flex items-center min-h-[400px] md:min-h-[550px] lg:min-h-[700px] overflow-hidden'>
          ...
          <div className='container mx-auto flex flex-col md:flex-row items-center md:justify-between py-4 md:py-0'>
